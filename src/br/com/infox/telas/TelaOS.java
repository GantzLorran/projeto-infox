...
public class TelaOS extends javax.swing.JInternalFrame {
    ...
    private void imprimir_os(){
        // imprimindo uma OS com o framework JasperReports
        ...
        if(confirma == JOptionPane.YES_OPTION){
            ...
            try {
                ...
                filtro.put("os",Integer.parseInt(txtOs.getText()));//o nome os é o mesmo nome que eu criei no IReport
                //Usando a classe JasperPrint para preparar a impressão de um relatório
                JasperPrint print = JasperFillManager.fillReport("C:/report/os.jasper",null,conexao);
    ...
    private void initComponents() {
        ...
        cboOsSit.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Na Bancada", "Estrega OK", "Orçamento REPROVADO", "Aguardando aprovação", "Aguardando peças", "abandonado pelo Cliente", "Retornou", " " }));
        ...
        btnOsExcluir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infox/icones/deletar.png"))); // NOI18N
        ...
        btnOsImprimir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infox/icones/print-icon.png"))); // NOI18N
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                .addComponent(txtOsTec, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(148, 148, 148)
                            ...
                            .addComponent(txtOsEquip, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 469, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(91, 91, 91)
    ...
    private void rbtOsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbtOsActionPerformed
        // a linha abaixo atribui um texto a variavel tipo se o radioButton estiver selecionado
        tipo = "OS";
    ...
    private void btnOsExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOsExcluirActionPerformed
        // chamando metodo para excluir uma OS
        excluir_os();
